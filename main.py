...
def create_result(flows):
    with open("result1.txt", 'w', encoding='utf-8') as file:  # 결과 파일 생성
...
def __analyze_method(flows):
    json_file_path = "C:/Users/gkds0/OneDrive/바탕 화면/core1/Core1/analysis_result.json" 
    ...
    for flow in flows:
        ...
        for count in range(1, len(flow)):
            ...
            current_path = tainted._file_path  # current_path는 실제 코드에 맞게 설정
